...
```
`r if (saveAudio) {saveAudioFun('s001', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s001.mp3" type="audio/mp3"> </audio>'}`
...
# playme(s)
```
`r if (saveAudio) {saveAudioFun('s002', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s002.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s003', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s003.mp3" type="audio/mp3"> </audio>'}`
...
# playme(s)
```
`r if (saveAudio) {saveAudioFun('s004', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s004.mp3" type="audio/mp3"> </audio>'}`
...
# playme(s)
```
`r if (saveAudio) {saveAudioFun('s005', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s005.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s006', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s006.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s007', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s007.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s008', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s008.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s009', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s009.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s010', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s010.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s011', samplingRate = 44100)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s011.mp3" type="audio/mp3"> </audio>'}`

```{r} 
# up and down
s012 = soundgen(pitch = c(150, 250, 100), sylLen = 700, play = playback) 
```
`r if (saveAudio) {saveAudioFun('s012', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s012.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s013', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s013.mp3" type="audio/mp3"> </audio>'}`
...
par(mfrow = c(1, 1))
```
`r if (saveAudio) {saveAudioFun('s014', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s014.mp3" type="audio/mp3"> </audio>'}`
...
s015 = soundgen(
  ...
  pitch = list(time = c(0, .1, 1),  # or (c(0, 30, 300)) - in ms
               value = c(350, 700, 350)))
```
`r if (saveAudio) {saveAudioFun('s015', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s015.mp3" type="audio/mp3"> </audio>'}`
...
s016 = soundgen(sylLen = 800, plot = TRUE, play = playback,
                ...
                samplingRate = 22050)
```
`r if (saveAudio) {saveAudioFun('s016', samplingRate = 22050)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s016.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s017', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s017.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s018', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s018.mp3" type="audio/mp3"> </audio>'}`
...
s019 = soundgen(vibratoDep = rnorm(n = 10, mean = .5, sd = .1), 
                ...
                play = playback, plot = TRUE)
```
`r if (saveAudio) {saveAudioFun('s019', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s019.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s020', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s020.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s021', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s021.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s022', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s022.mp3" type="audio/mp3"> </audio>'}`
...
s023 = soundgen(
  ...
  formants = NA, pitch = 220, vocalTract = 15, play = playback)
```
`r if (saveAudio) {saveAudioFun('s023', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s023.mp3" type="audio/mp3"> </audio>'}`
...
s024 = soundgen(
  ...
  formants = NA, pitch = 220, vocalTract = 15, play = playback)
```
`r if (saveAudio) {saveAudioFun('s024', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s024.mp3" type="audio/mp3"> </audio>'}`
...
# playme(s025)
```
`r if (saveAudio) {saveAudioFun('s025', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s025.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s026', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s026.mp3" type="audio/mp3"> </audio>'}`
...
s027 = soundgen(
  ...
  plot = TRUE, heights = c(1, 1), play = playback)
```
`r if (saveAudio) {saveAudioFun('s027', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s027.mp3" type="audio/mp3"> </audio>'}`
...
# playme(s)
```
`r if (saveAudio) {saveAudioFun('s028', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s028.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s029', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s029.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s030', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s030.mp3" type="audio/mp3"> </audio>'}`

```{r}
s031 = soundgen(formants = 'aaai', play = playback)
```
`r if (saveAudio) {saveAudioFun('s031', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s031.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s032', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s032.mp3" type="audio/mp3"> </audio>'}`

```{r fig.width = 7, fig.height = 5}
s033 = soundgen(formants = c(800, 1200), formantDepStoch = 0,
                play = playback, plot = TRUE)
```
`r if (saveAudio) {saveAudioFun('s033', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s033.mp3" type="audio/mp3"> </audio>'}`
...
s034 = soundgen(
  ...
  play = playback, plot = TRUE)
```
`r if (saveAudio) {saveAudioFun('s034', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s034.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s035', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s035.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s036', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s036.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s037', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s037.mp3" type="audio/mp3"> </audio>'}`
...
spectrogram(s038, samplingRate = 16000, 
            ...
            colorTheme = 'seewave')
```
`r if (saveAudio) {saveAudioFun('s038', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s038.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s039', samplingRate = 22000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s039.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s040', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s040.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s041', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s041.mp3" type="audio/mp3"> </audio>'}`
...
s042 = soundgen(sylLen = 1000, pitch = c(400, 430), formants = NULL,
                ...
                plot = TRUE, ylim = c(0, 4), play = playback)
```
`r if (saveAudio) {saveAudioFun('s042', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s042.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s043', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s043.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s044', samplingRate = 80000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s044.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s045', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s045.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s046', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s046.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s047', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s047.mp3" type="audio/mp3"> </audio>'}`
...
s048 = soundgen(subFreq = 400, subDep = c(5, 20),
                ...
                play = playback, plot = TRUE, ylim = c(0, 3))
```
`r if (saveAudio) {saveAudioFun('s048', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s048.mp3" type="audio/mp3"> </audio>'}`
...
s049 = soundgen(
  ...
  play = playback, plot = TRUE, ylim = c(0, 5))
```
`r if (saveAudio) {saveAudioFun('s049', samplingRate = 22050)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s049.mp3" type="audio/mp3"> </audio>'}`
...
s050 = soundgen(
  ...
  play = playback, plot = TRUE, ylim = c(0, 5))
```
`r if (saveAudio) {saveAudioFun('s050', samplingRate = 22050)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s050.mp3" type="audio/mp3"> </audio>'}`
...
s051 = soundgen(jitterLen = 40, jitterDep = 1,  # shaky voice
                ...
                play = playback, plot = TRUE, ylim = c(0, 3))
```
`r if (saveAudio) {saveAudioFun('s051', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s051.mp3" type="audio/mp3"> </audio>'}`
...
s052 = soundgen(jitterLen = 1, jitterDep = 1,   # harsh voice
                ...
                play = playback, plot = TRUE, ylim = c(0, 3))
```
`r if (saveAudio) {saveAudioFun('s052', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s052.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s053', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s053.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s054', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s054.mp3" type="audio/mp3"> </audio>'}`
...
s055 = soundgen(
  ...
  play = playback, plot = TRUE, ylim = c(0, 2))
```
`r if (saveAudio) {saveAudioFun('s055', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s055.mp3" type="audio/mp3"> </audio>'}`
...
s056 = soundgen(
  ...
  play = playback, plot = TRUE, ylim = c(0, 2))
```
`r if (saveAudio) {saveAudioFun('s056', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s056.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s057', samplingRate = 44100)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s057.mp3" type="audio/mp3"> </audio>'}`
...
s058 = soundgen(
  ...
  samplingRate = 44100, play = playback, plot = TRUE, ylim = c(0, 5))
```
`r if (saveAudio) {saveAudioFun('s058', samplingRate = 44100)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s058.mp3" type="audio/mp3"> </audio>'}`
...
# playme(s059)
```
`r if (saveAudio) {saveAudioFun('s059', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s059.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s060', samplingRate = 22050)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s060.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s061', samplingRate = 22050)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s061.mp3" type="audio/mp3"> </audio>'}`
...
s062 = soundgen(sylLen = 800, pitch = 300, temperature = 0.001,
                ...
                play = playback, plot = TRUE, ylim = c(0, 4))
```
`r if (saveAudio) {saveAudioFun('s062', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s062.mp3" type="audio/mp3"> </audio>'}`
...
s063 = soundgen(sylLen = 800, pitch = 300, temperature = 0.001,
              ...
              play = playback, plot = TRUE, ylim = c(0, 4))
```
`r if (saveAudio) {saveAudioFun('s063', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s063.mp3" type="audio/mp3"> </audio>'}`
...
s064 = soundgen(sylLen = 800, pitch = 500, temperature = 0.001,
                ...
                play = playback, plot = TRUE, ylim = c(0, 4))
```
`r if (saveAudio) {saveAudioFun('s064', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s064.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s065', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s065.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s066', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s066.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s067', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s067.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s068', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s068.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s069', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s069.mp3" type="audio/mp3"> </audio>'}`
...
s070 = soundgen(pitch = NULL, 
                ...
                play = playback, plot = TRUE)
```
`r if (saveAudio) {saveAudioFun('s070', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s070.mp3" type="audio/mp3"> </audio>'}`
...
s071 = soundgen(vocalTract = 15.5, 
                ...
                play = playback, plot = TRUE)
```
`r if (saveAudio) {saveAudioFun('s071', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s071.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s072', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s072.mp3" type="audio/mp3"> </audio>'}`
...
s073 = soundgen(noiseAmpRef = 'f0', rolloff = -1, 
                ...
                play = playback)
```
`r if (saveAudio) {saveAudioFun('s073', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s073.mp3" type="audio/mp3"> </audio>'}`
...
s074 = soundgen(noiseAmpRef = 'f0', rolloff = -15, 
                ...
                play = playback)
```
`r if (saveAudio) {saveAudioFun('s074', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s074.mp3" type="audio/mp3"> </audio>'}`
...
s075 = soundgen(noiseAmpRef = 'source', rolloff = -15, rolloffNoise = 0,
                ...
                play = playback)
```
`r if (saveAudio) {saveAudioFun('s075', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s075.mp3" type="audio/mp3"> </audio>'}`
...
s076 = soundgen(noiseAmpRef = 'source', rolloff = -1, rolloffNoise = -20,
                ...
                play = playback)
```
`r if (saveAudio) {saveAudioFun('s076', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s076.mp3" type="audio/mp3"> </audio>'}`
...
s077 = soundgen(noiseAmpRef = 'source', formants = 'a', 
                ...
                play = playback)
```
`r if (saveAudio) {saveAudioFun('s077', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s077.mp3" type="audio/mp3"> </audio>'}`
...
s078 = soundgen(noiseAmpRef = 'source', formants = 'u',
                ...
                play = playback)
```
`r if (saveAudio) {saveAudioFun('s078', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s078.mp3" type="audio/mp3"> </audio>'}`
...
s079 = soundgen(noiseAmpRef = 'filtered', formants = 'a', 
                ...
                play = playback)
```
`r if (saveAudio) {saveAudioFun('s079', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s079.mp3" type="audio/mp3"> </audio>'}`
...
s080 = soundgen(noiseAmpRef = 'filtered', formants = 'u',
                ...
                play = playback)
```
`r if (saveAudio) {saveAudioFun('s080', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s080.mp3" type="audio/mp3"> </audio>'}`
...
s081 = soundgen(nSyl = 2,
                ...
                plot = TRUE, ylim = c(0, 4), play = playback)
```
`r if (saveAudio) {saveAudioFun('s081', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s081.mp3" type="audio/mp3"> </audio>'}`
...
s082 = soundgen(
  ...
  plot = TRUE, ylim = c(0, 4), play = playback)
```
`r if (saveAudio) {saveAudioFun('s082', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s082.mp3" type="audio/mp3"> </audio>'}`
...
s083 = soundgen(
  ...
  plot = TRUE, ylim = c(0, 4), play = playback)
```
`r if (saveAudio) {saveAudioFun('s083', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s083.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s084', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s084.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s085', samplingRate = samplingRate)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s085.mp3" type="audio/mp3"> </audio>'}`
...
# playme(s086)
```
`r if (saveAudio) {saveAudioFun('s086', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s086.mp3" type="audio/mp3"> </audio>'}`
...
```
`r if (saveAudio) {saveAudioFun('s087', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s087.mp3" type="audio/mp3"> </audio>'}`
...
# playme(cand1)
```
`r if (saveAudio) {saveAudioFun('s088', samplingRate = 16000)}`
`r if (saveAudio) {'<audio controls style = "display: block"> <source src="sounds/s088.mp3" type="audio/mp3"> </audio>'}`
