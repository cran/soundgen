...
*TIP The parameter `attackLen` affects both the beginning and the end of a syllable. For asymmetrical attack, keep `attackLen` low and apply `fade(fadeIn = ..., fadeOut = ...)` to the synthesized sound in post-production. Avoid `attackLen = 0`, since that can cause clicks*
