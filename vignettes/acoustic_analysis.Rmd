...
* `amDep`: depth of amplitude modulation, dB (estimated by `modulationSpectrum`, the arguments to which are passed in `roughness = list()`)
* `amFreq`: frequency of amplitude modulation, Hz (estimated by `modulationSpectrum`, the arguments to which are passed in `roughness = list()`)
