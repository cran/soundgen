...
* `roughness`: the amount of spectrotemporal modulation in the "roughness" zone of frequencies (estimated by `modulationSpectrum`, the arguments to which are passed in `roughness = list()`)
...
*BUT: do NOT use the "dom" pitch estimate if f0 is either filtered out or invisible because of noise!*
